...
// File: contracts/BIFI/strategies/Curve/StrategyCurveGeistLP.sol
...
contract StrategyCurveGeistLP is StratManager, FeeManager, GasThrottler {
        ...
        )
    {
        ...
        require(
            _geistToNativeRoute[_geistToNativeRoute.length - 1] == native,
            "_geistToNativeRoute[last] != native"
        );
    ...
    function chargeFees() internal {
        ...
        uint256 nativeFeeBal = IERC20(native)
    ...
    function addLiquidity() internal {
        ...
        if (poolSize == 2) {
            ...
            amounts[depositIndex] = depositBal;
            if (useUnderlying)
                ICurveSwap3(pool).add_liquidity(amounts, 0, true);
    ...
    function setCrvRoute(address _router, address[] memory _crvToNative)
        external
        onlyManager
    {
    ...
    function _giveAllowances() internal {
        ...
        IERC20(geist).safeApprove(unirouter, type(uint256).max);
